...
function Home() {
    return (
        <div className=' home-bg w-full h-[100vh] flex text-center lg:p-[10rem] lg:pb-[5rem] p-[1.5rem]'>
            <div className='flex lg:flex-row flex-col pb-[1rem] lg:gap-0 gap-[2rem] lg:justify-between justify-center lg:items-end items-center w-full ' >
                ...
                <div className='button1 w-[274px] h-[274px] --fontfamily--300 heading-font-400  bg-white rounded-full cursor-pointer flex justify-center items-center ' >
                    EXPLORE
                    <div className='lg:w-[274px]w-[250px]  lg:h-[274px] h-[250px] bg-white rounded-full absolute opacity-[0.5]' />
                </div>
            </div>
        </div>
    )
